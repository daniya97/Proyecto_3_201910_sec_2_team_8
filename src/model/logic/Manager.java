...
public class Manager {
	...
	/**
	 * Grafo de la componente conectada mï¿½s grande
	 */
	 ...
	 */
	/**
	 * Encuentra el camino mï¿½s corto (en infracciones) entre idVertice1 y idVertice 2
	 */
	public void caminoCostoMinimoA1(BigInteger idVertice1, BigInteger idVertice2) throws IOException{
		...
		if(nuevo.existeCaminoHasta(verticeDestino)){
			...
			System.out.println("El nï¿½mero de infracciones del camino es: " + encontrarInfracciones(resultadosVerticesID));
	 ...
	 */
	/**
	 * Encuentra el camino mï¿½s corto en cuanto a mï¿½nima cantidad de arcos
	 */
	 ...
	 */
	/**
	 * Mï¿½todo que define la cuadrï¿½cula dado los parï¿½metros dado por el usuario
	 */
	 ...
	 */
	/**
	 * Camino mï¿½s corto entre dos vï¿½rtices
	 * Tiene en cuenta dos criterios: nï¿½mero infracciones y cantidad de vï¿½rtices
	 */
